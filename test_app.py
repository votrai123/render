...
class TestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.user_view_token = 'eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6InBHWEVhakU4TXN0WmIyejdwcHpmZSJ9..hrCH0PDvoB32cO6axk57oU6mOAejEjOIB26HnfZNh30sNaiScqHyNTjRTA-IfYMSyFaGYCUoJhEElz1F2TqJN-cGySUmE6zWOEWflZFiLp7nJBIptxuiOY_uzCypYeTzmIe-8uW1MYto1rYpmgwK_I7kJRldz4kGrNdG9GWRFrICTSBPNp-eIEr5rLUEGTbc_4zKHAKpYBKHKkjfSRJKS-K6pvADJuk3a6Cn_JtxorrG_J086CGBVGpuiJbXdOtwIkH8QdrWuZRw8NsQ6q_JB03C3YeomuB1-NQKQeeP7zvbq5uHePAKIRGPQkOIArWeq_EXPFn7IPyelbtUicWfTw'
        self.manager_token = 'eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6InBHWEVhakU4TXN0WmIyejdwcHpmZSJ9..5r0MHTcsC-LkfCa-mpMkAh2eeJ4ocRLi_lTZ1REknGx-a4h4z4x_v7ax1GcFQXhLSdzrRYtrBD3c71q9VhlThSfggECIjh3TVm-MnbzcinJ5jr9AtKZzADkPTOK7cnQu2eLvYYOOW6YMo38ccwqmYWexCC1xP7vHa81fOFAIf4zuhlgeus9qqo9w92Lf6v09eVsOqiosqZixK5T1418c3eil-tR6aVD8FE87zvkyU-HqlLCidlWS13I7kTcovaGxz8Frm5uqphN6KB6HgnbTNZMNCv6RcyZg42St4Hvyc8hu6aRAEBfaOQzt39xOt3GBc1SJsUhSTA8Ezo2QFvM7wA'
    ...
    def test_get_books_success(self):
        ...
        res = self.client().get('/books', headers=self.get_headers(self.user_view_token))
    ...
    def test_create_book_success(self):
        ...
        res = self.client().post('/books', json=self.new_book, headers=self.get_headers(self.manager_token))
        data = json.loads(res.data)
    ...
    def test_create_book_bad_request(self):
        ...
        res = self.client().post('/books', json={}, headers=self.get_headers(self.manager_token))
        data = json.loads(res.data)
    ...
    def test_delete_book_success(self): 
        ...
        res = self.client().delete(f'/books/{book_id}', headers=self.get_headers(self.manager_token)) 
        data = json.loads(res.data) 
        self.assertEqual(res.status_code, 200) 
        self.assertTrue(data['success']) 
    ...
    def test_delete_book_not_found(self):
        ...
        res = self.client().delete('/books/9999', headers=self.get_headers(self.manager_token))
        data = json.loads(res.data)
    ...
    def test_get_authors_success(self):
        ...
        res = self.client().get('/authors', headers=self.get_headers(self.user_view_token))
        data = json.loads(res.data)
    ...
    def test_create_author_success(self):
        ...
        res = self.client().post('/authors', json=self.new_author, headers=self.get_headers(self.manager_token))
        data = json.loads(res.data)
    ...
    def test_create_author_bad_request(self):
        ...
        res = self.client().post('/authors', json={}, headers=self.get_headers(self.manager_token))
        data = json.loads(res.data)
    ...
    def test_delete_author_success(self):
        ...
        res = self.client().delete(f'/authors/{author_id}', headers=self.get_headers(self.manager_token))
        data = json.loads(res.data)
    ...
    def test_delete_author_not_found(self):
        ...
        res = self.client().delete('/authors/9999', headers=self.get_headers(self.manager_token))
        data = json.loads(res.data)
    ...
    def test_create_author_role_based_access(self):
        ...
        res = self.client().post('/authors', json=self.new_author, headers=self.get_headers(self.user_view_token))
        data = json.loads(res.data)
